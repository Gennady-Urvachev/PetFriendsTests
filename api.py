...
class PetFriends:
    ...
    def add_pet_without_photo(self, auth_key: json, name: str, animal_type: str, age: int) -> json:
        """Метод отправляет запрос на добавление питомца без фото, возвращает статус и result
        в формате JSON с данными питомца"""
    ...
    def add_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет запрос на добавление фото питомца и возвращает статус запроса и
        result в формате json с фото по ID питомца"""
